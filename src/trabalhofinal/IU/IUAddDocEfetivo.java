 ...
 * @author dayan
 */
public class IUAddDocEfetivo extends javax.swing.JDialog {

    /**
     * Creates new form IUAddFuncionario
     */
    public IUAddDocEfetivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxNivel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "D1", "D2", "D3" }));
        ...
        cbxArea.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Biológicas", "Exatas", "Humanas", "Saúde" }));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cbxArea, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(58, 58, 58))
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (!(txtCod.getText().equals("")) && !(txtNome.getText().equals("")) && !(txtSalario.getText().equals(""))) {
            ...
            Float salarioFinal = control.addEfetivo(cod, nome, salario, nivel, titulacao, area, depart);

            lblSalarioFinal.setText(Constantes.dinheiro.format(salarioFinal));

            JOptionPane.showMessageDialog(null, "Docente efetivo cadastrado!");
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUAddDocEfetivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUAddDocEfetivo dialog = new IUAddDocEfetivo(new javax.swing.JFrame(), true);
